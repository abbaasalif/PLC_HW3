    ...
    */
    ...
    constructor() {
        ...
        this.arrayInitialization = () => {
            ...
            for (let i = 0; i < this.cells_in_rows; i++) {
                for (let j = 0; j < this.cells_in_column; j++) {
                    this.active_array[j * this.cells_in_rows + i] = 0;
                }
            }
        ...
        this.arrayRandomize = () => {
            ...
            for (let i = 0; i < this.cells_in_rows; i++) {
                for (let j = 0; j < this.cells_in_column; j++) {
                    this.active_array[j * this.cells_in_rows+i] = (Math.random() > 0.5) ? 1 : 0;
                }
            }
        ...
        this.fillArray = () => {
            ...
            for (let i = 0; i < this.cells_in_rows; i++) {
                for (let j = 0; j < this.cells_in_column; j++) {
                    let color;
                    if (this.active_array[j * this.cells_in_rows + i] == 1)
        ...
        this.setCellValueHelper = (row, col) => {
            try {
                return this.active_array[col * this.cells_in_rows + row];
            }
            catch {
                return 0;
            }
        ...
        this.updateCellValue = (row, col) => {
            ...
            else if (this.active_array[col * this.cells_in_rows + row] === 0 && total === 3) {
                return 1;
            }
        ...
        this.updateLifeCycle = () => {
            ...
            for (let i = 0; i < this.cells_in_rows; i++) {
                for (let j = 0; j < this.cells_in_column; j++) {
                    ...
                    this.inactive_array[j * this.cells_in_rows + i] = new_state;
                }
            }
